...
public class Main {
    ...
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
        ...
        System.out.println("CSCI 576 Final Project by:");
        System.out.println("Bhumi Patel\nSheryll Howell\nBryce Tinges\n");
        ...
        */
        ...
        double startSeconds = Integer.parseInt(overallBestMatch[1]) / 30.0;
    ...
    private static String[] findOverallMatch(List<String[]> audioResults, List<String[]> motionResults) {
        ...
        boolean audioMatchConfident = audioResults.size() >= 1 && "TRUE".equals(audioResults.get(0)[3]);
        ...
        // If neither motion nor audio results are confident, prioritize audio result
